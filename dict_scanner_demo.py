#!/usr/bin/env python3
"""
Dictionary Scanner Demo - Test les nouvelles fonctionnalités de ShadowProtocol

Usage:
  python3 dict_scanner_demo.py <binary_path> <keywords.txt>
  python3 dict_scanner_demo.py <binary_path> "keyword1,keyword2,keyword3"
"""
